...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{ url('dashboard') }}">KS Subur Makmur</a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ route('shu.index') }}">
                            <div class="sb-nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        {{-- <nav class="sb-sidenav-menu nav accordion" id="sidenavAccordionPages">
                            ...
                            <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('simpanan.pokok.index') }}">Simpanan Pokok</a>
                                    <a class="nav-link" href="{{ route('simpanan.wajib.index') }}">Simpanan Wajib</a>
                                    <a class="nav-link" href="{{ route('simpanan.sukarela.index') }}">Simpanan
                                        Sukarela</a>
